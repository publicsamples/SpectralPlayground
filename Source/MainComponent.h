...
private:
    ...
    void stopPlayback();
    void applyAnalysisPreset(int presetId);
    AnalysisSettings getAnalysisSettings() const;
    juce::String buildDiagnosticsText() const;
    juce::AudioBuffer<float> readSourceSelectionBuffer() const;
    ...
    juce::Label analysisSectionLabel;
